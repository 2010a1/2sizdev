...
export interface ABCDQuestion extends BaseQuestion { type:"ABCD"; options:QuestionOption[]; correctOptionId:string; }
...
export interface SharedExamRef { id:string; examId:string; code:string; expiresAt?:number; importedAt:number; ownerName?:string; ownerAvatar?:string; }
