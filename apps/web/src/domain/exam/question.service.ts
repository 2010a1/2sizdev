...
const base=z.object({id:z.string().min(1),examId:z.string().min(1),order:z.number().int().nonnegative(),content:z.string().trim().min(1),explanation:z.string().optional(),points:z.number().positive(),imageAssetId:z.string().optional()});
export const QuestionSchema=z.discriminatedUnion('type',[
 ...
 base.extend({type:z.literal('TRUE_FALSE'),correctAnswer:z.boolean()}),
