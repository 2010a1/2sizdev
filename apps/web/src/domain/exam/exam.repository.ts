...
export const examRepository = {
  ...
  async duplicateExam(id: string, exam: Exam, questions: Question[], assets: ExamAssetRecord[] = []) {
  ...
  async getAsset(id: string) { return db.examAssets.get(id); },
  async putAsset(asset: ExamAssetRecord) { await db.examAssets.put(asset); },
  async updateAsset(id: string, patch: Partial<ExamAssetRecord>) { await db.examAssets.update(id, patch); },
