...
export function RegisterPage(){
  ...
  return <div className="min-h-screen grid place-items-center p-4 bg-[var(--surface-2)]"><form onSubmit={submit} className="card w-full max-w-md p-7 space-y-4">
    <div><span className="eyebrow">TÀI KHOẢN</span><h1 className="mt-2 text-2xl font-extrabold">Tạo tài khoản</h1><p className="mt-2 text-sm muted">Chỉ cần tên, username và mật khẩu. Không cần Gmail/email.</p></div>
    ...
    <p className="text-sm muted">Đã có tài khoản? <Link className="font-semibold text-accent-strong" to="/login">Đăng nhập</Link></p>
  </form></div>
}
